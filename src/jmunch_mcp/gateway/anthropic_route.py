...
def _handleify_request_messages(
    ...
    *,
    ...
    envelope. Gated by the context-aware fraction gate and the recency
    window (last N tool_result blocks left verbatim) — see the OpenAI
    route's twin for the rationale.
    """
